...
var CommentsService = /** @class */ (function () {
    ...
    CommentsService.prototype.getComments = function () {
        return this.http.get(this.commentsUrl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (data) { return console.log('All: ' + JSON.stringify(data)); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
    CommentsService.prototype.handleError = function (err) {
        var errorMessage = '';
...
var NewPostComponent = /** @class */ (function () {
    function NewPostComponent(router) {
        this.router = router;
    }
    NewPostComponent.prototype.ngOnInit = function () {
    };
    NewPostComponent.prototype.onBack = function () {
        this.router.navigate(['/welcome']);
    };
    NewPostComponent.prototype.showAlert = function () {
...
var PostService = /** @class */ (function () {
    ...
    PostService.prototype.getProducts = function () {
        return this.http.get(this.postsUrl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (data) { return console.log('All: ' + JSON.stringify(data)); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
...
var PostsListComponent = /** @class */ (function () {
    // bodyText: string;
    function PostsListComponent(postService, commentsService, usersService, router) {
        this.postService = postService;
        this.commentsService = commentsService;
        this.usersService = usersService;
        this.router = router;
        this.paginationButtons = Array(10).fill(1).map(function (item, index) { return index; });
        this.currentPage = 0;
        this.posts = [];
        this.comments = [];
        this.users = [];
    }
    PostsListComponent.prototype.setPage = function (pageNumber) {
    ...
    PostsListComponent.prototype.onCreatePost = function () {
...
var PostsComponent = /** @class */ (function () {
    function PostsComponent(modalService) {
        this.modalService = modalService;
    }
    ...
    PostsComponent.prototype.openModal = function (id, postId) {
        this.postId = postId;
        this.modalService.open(id);
        this.currentComments = this.comments.filter(function (comment) { return comment.postId === +postId; });
        this.bodyText = this.currentComments;
    };
    PostsComponent.prototype.closeModal = function (id) {
        this.modalService.close(id);
    };
    PostsComponent.prototype.openAuthor = function (id, userId) {
        this.userId = userId;
        this.modalService.open(id);
        // this.users.forEach(us => us.id === +userId ? console.log(us.name) : null);
        this.user = this.users.filter(function (us) { return us.id === +userId; });
        this.user = this.user[0];
    };
    PostsComponent.prototype.closeAuthor = function (id) {
        this.modalService.close(id);
    };
